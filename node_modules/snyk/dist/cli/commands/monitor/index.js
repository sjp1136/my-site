    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const path of args) {
            ...
            try {
                ...
                const analysisType = (options.docker ? 'docker' : guessedPackageManager) || 'all';
                ...
                const inspectResult = yield promiseOrCleanup(get_deps_from_plugin_1.getDepsFromPlugin(path, Object.assign(Object.assign({}, options), { path, packageManager: guessedPackageManager })), spinner.clear(analyzingDepsSpinnerLabel));
