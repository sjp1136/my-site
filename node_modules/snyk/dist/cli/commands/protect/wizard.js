...
function loadOrCreatePolicyFile(options) {
    return __awaiter(this, void 0, void 0, function* () {
        let policyFile;
        try {
            policyFile = yield snyk.policy.load(options['policy-path'], options);
            return policyFile;
        }
        catch (error) {
...
function processWizardFlow(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const message = options['dry-run']
            ...
            : '~~~~ LIVE RUN ~~~~';
        debug(message);
        const policyFile = yield loadOrCreatePolicyFile(options);
        const authed = yield auth.isAuthed();
        ...
        const cliIgnoreAuthorization = yield authorization.actionAllowed('cliIgnore', options);
...
function processAnswers(answers, policy, options) {
    ...
    const res = protect
        ...
        .then((policy2) => __awaiter(this, void 0, void 0, function* () {
        if (!live) {
        ...
        yield policy2.save(cwd, spinner);
        ...
        const npmVersion = yield npm.getVersion();
